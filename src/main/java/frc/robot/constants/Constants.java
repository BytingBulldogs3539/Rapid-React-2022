...
/***
 * An outline for two classes containing constants for both the practice bot and
 * the comp bot.
 */
public abstract class Constants {
    ...
    public abstract class ShooterConstants {
        ...
        /***
         * @return The values of the gear ratio and inverted constants for shooter motor
         *         1
         */
    ...
    /***
     * Class containing the Pneumatics Constants (for the compressor & the
     * solenoids)
     */
